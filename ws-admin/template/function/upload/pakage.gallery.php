...
$insert_data = array(
'event_pakage_id'           => mysqli_real_escape_string($data->con, $_GET['id']),
'eventpakage_images_name'   => mysqli_real_escape_string($data->con, $new_image_name)
);
if($data->insert('eventpakage_images', $insert_data))
{
$resMessage = 'ok';
}
}else{
