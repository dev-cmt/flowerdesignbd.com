...
$resMessage = 'err';
} else if ($_FILES["file"]["size"][$key] > 2097152) {
$resMessage = 'err';
...
$insert_data = array(
'theme_defgallery_image'   => mysqli_real_escape_string($data->con, $new_image_name)
);
if($data->insert('theme_default_gallery', $insert_data))
{
$resMessage = 'ok';
}
}else{
