...
<li><i class="bi bi-check2"></i> Please change the maximum image size 512x512 PX</li>
...
<?php
$clientQ = "SELECT * FROM   client_logo";
...
<img data-dz-thumbnail class="img-fluid rounded d-block"  src="<?php echo pathUrl(__DIR__ . '/../../../../'); ?>uploads/client/logo/<?php echo $clientRow['clientlogo_images']; ?>" />
</div>
</div>
...
<button type="button" data-dz-remove id="<?php echo $clientRow['clientlogo_id']; ?>" class="btn btn-sm btn-danger ImageDel id120">Delete</button>
</div>
</div>
</div>
</li>
...
var clientdelID  = $(this).attr("id");
$.ajax({
url: baseUrl + urldelect + baseUrlformat,
method:"post",
data:{clientdelID:clientdelID},
dataType:"text",
...
var minImageWidth = 512, minImageHeight = 512;
var myDropzone = new Dropzone("#dropzone", {
url: "../template/function/upload/client.logo.php",
method: "POST",
paramName: "file",
