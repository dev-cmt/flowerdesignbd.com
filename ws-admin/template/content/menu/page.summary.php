...
<li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-semibold fs-14">Admin Menu</a></li>
<li>
...
{
$suboutput = '';
$submenuQ = "SELECT * FROM sub_menu WHERE menu_id='".$row['menu_id']."'";
$submenuQ_data = $data->con->query($submenuQ);
foreach($submenuQ_data as $subRow)
{
$suboutput .='
<li class="col-sm-6">
<a href="javascript: void(0);">'.$subRow['submenu_name'].'</a>
</li>
';
}
$output .= '
<li class="col-sm-2">
<a href="javascript: void(0);" class="sub-title">'.$row['menu_name'].'</a>
