...
<img class="lazy" data-srcset="<?php echo pathUrl(__DIR__ . '/../../../../'); ?>uploads/logo/cms.logo.png" alt="" height="100">
</a>
</div>
...
<div class="mt-3">
<button type="button" class="btn btn-success w-100 authbutton submit">Confirm</button>
</div>
</div>
</div>
<!-- end card body -->
...
<p class="mb-0">Didn't receive a code ? <a href="<?php echo pathUrl(__DIR__ . '/../../../'); ?>recovery" class="fw-semibold text-primary text-decoration-underline">Resend</a> </p>
</div>
</div>
</div>
</div>
