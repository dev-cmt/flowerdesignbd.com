...
let loadUrl       = '/template/content/menu/submenu.content';
...
{
load_data(1);
function load_data(page, query = '<?php if(!empty($menuID)){ echo $menuID; }else{ echo $menuID = ''; } ?>', update = '<?php if(!empty($submenuID)){ echo $submenuID; }else{ echo $submenuID = ''; } ?>')
{
$.ajax({
