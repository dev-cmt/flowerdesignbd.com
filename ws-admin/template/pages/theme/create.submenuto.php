...
let loadUrl       = '/template/content/theme/submenuto.content';
...
{
load_data(1);
function load_data(page, query = '<?php if(!empty($themeID)){ echo $themeID; }else{ echo $themeID = ''; } ?>', update = '<?php if(!empty($updateD)){ echo $updateD; }else{ echo $updateD = ''; } ?>')
{
$.ajax({
